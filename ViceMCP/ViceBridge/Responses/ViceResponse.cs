...
namespace ViceMCP.ViceBridge.Responses
{
    ...
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc cref="ViceMCP.ViceBridge.Responses.ViceResponse" /></param>
    /// <param name="ErrorCode"><inheritdoc cref="ViceMCP.ViceBridge.Responses.ViceResponse" /></param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.CheckpointListCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    /// <param name="TotalNumberOfCheckpoints"></param>
    /// <param name="Info">An array of matching <see cref="ViceMCP.ViceBridge.Responses.CheckpointInfoResponse"/>.</param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.RegistersGetCommand"/> and 
    /// <see cref="ViceMCP.ViceBridge.Commands.RegistersSetCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    /// <param name="Items">
    ...
    public record RegistersResponse(byte ApiVersion, ErrorCode ErrorCode, ImmutableArray<RegisterItem> Items) 
        : ViceResponse(ApiVersion, ErrorCode);
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.UndumpCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.ResourceGetCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.BanksAvailableCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.RegistersAvailableCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
    ...
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.AutoStartCommand"/>.
    /// </summary>
    public record AutoStartResponse(byte ApiVersion, ErrorCode ErrorCode): ViceResponse(ApiVersion, ErrorCode);
    /// <summary>
    /// Response to <see cref="ViceMCP.ViceBridge.Commands.InfoCommand"/>.
    /// </summary>
    /// <param name="ApiVersion"><inheritdoc /></param>
    /// <param name="ErrorCode"><inheritdoc /></param>
